...
import {Button, Icon, Drawer, List, NavBar} from 'antd-mobile';
    ...
    return (
      <div>
        ...
        >
          ...
          <Button type="primary" inline size="small" className={styles["my-button"]} style={{ marginRight: '4px' }}>primary</Button>
